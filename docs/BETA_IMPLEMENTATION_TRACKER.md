...
| Version during development | `1.0.28` → `1.1.0` (bumped once at phase 17, 2026-09-09)                                                                             |
...
- Artifact: `release\Job-Browser-Setup-1.1.0.exe` (253,533,832 B,
...
- Current installer: `release\Job-Browser-Setup-1.1.0.exe`, 253,533,832 B, SHA-256
  `E68D623699A46DE8C3C8534DB38FF54CE4887428A865AC0838F8F8512D8FBAD9`. Packaged `app.asar` =
  73,681,830 B (SHA `2F4FD44A18B98E72D7BD9007171FB519C5537C8B013374B1135864195C899C9F`).
