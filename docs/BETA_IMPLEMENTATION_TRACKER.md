...
- (this update) — recovery: adoption markers completed to full scope (route, client, Settings UI, tests), POST /api/sources ordering fixed (DEF-003), privacy-distribution flake timeout raised, tracker corrected (phase 17 reverted [ ]). Verify green 108/1101. NOT pushed.
