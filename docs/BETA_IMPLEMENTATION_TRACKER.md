...
| Version during development | `1.0.28` → `1.1.0` (phase 17, 2026-09-09) → `1.1.1` startup patch (2026-09-11)                                                       |
...
- Current artifact: `release\Job-Browser-Setup-1.1.1.exe` (253,596,928 B,
  SHA-256 `1101A3795CCB930C9966DC02198B60EFCF757221496B61728C2B9C9E8886C815`);
  installed copy asar-identical. Packaged, installed, and seeded upgrade smokes pass.
...
- Current installer: `release\Job-Browser-Setup-1.1.1.exe`, 253,596,928 B, SHA-256
  `1101A3795CCB930C9966DC02198B60EFCF757221496B61728C2B9C9E8886C815`. Packaged `app.asar` =
  74,041,483 B (SHA `CEE52B0E0F625F25B26970ECCFF8637C27CFA2E0C243484FF3E76930613BB35F`).
- Installed app = 1.1.1 (silently upgraded over 1.1.0 during P31 validation; installed
  asar SHA == packaged asar; exe reports version 1.1.1 at `%LOCALAPPDATA%\Programs\Job Browser\`).
  Packaged, installed, and seeded upgrade smokes passed.
