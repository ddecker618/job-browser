...
| 17    | Version bump (ONLY here) + version-checks + CSP + final gates                                                        | [ ]    | 1.0.28 → 1.1.0 target. NOTE: previous model marked [x] without bumping — corrected; bump only after all pre-release work verified.                                                                                                                                                                                                                                                                                                                                                                                                             |
...
- [ ] Full phase list 2–9, 12–18 per Phase Progress (reconciles at phase 18).
