...
| 12    | Docs: index page with**every** known quirk (incl. Dice hang)                                                         | [~]    | `docs/KNOWN_QUIRKS.md` index LANDED (Dice-hang DEF-001, HITL providers, pacing, dom-content waits, retries, interrupted/empty semantics, cadence, FTS fallback, packaging, privacy)                                                                                                                                                                                                                                                                                                                                                            |
